...
export default function WriteMyPost() {
  ...
  return <div className="card">
    ...
    <div className="card-body">
      <textarea rows={4} ref={postInputRef} style={{resize: "none"}} placeholder="Your Post Here..." value={post} onChange={e => setPost(e.target.value)} className="form-control"></textarea>
    </div>
